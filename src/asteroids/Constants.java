...
public class Constants
{
    ...
    /**********************************************************************
     * Amount of "friction" that can be applied to ships so that they 
     * eventually stop. Should be negative.
     **********************************************************************/
    ...
    /**********************************************************************
     * The number of milliseconds between the end of a life and the display 
     * of the next screen.
     **********************************************************************/
